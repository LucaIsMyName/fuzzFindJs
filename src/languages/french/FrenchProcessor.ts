...
export class FrenchProcessor extends BaseLanguageProcessor {
  ...
  protected getCommonEndings(): string[] {
    return [
      'e', 'es', 's', 'x', 'ent', 'ant', 'ment', 'tion', 'sion',
      'eur', 'euse', 'teur', 'trice', 'able', 'ible', 'ique',
      'aire', 'oire', 'ette', 'elle', 'esse', 'asse', 'isse',
      'age', 'isme', 'iste', 'ite', 'ude', 'ade'
    ];
  }
  ...
  getSynonyms(word: string): string[] {
    const synonymMap: Record<string, string[]> = {
      ...
      'hopital': ['clinique', 'centre medical'],
      'ecole': ['etablissement', 'institution'],
      'voiture': ['automobile', 'vehicule', 'auto'],
      'maison': ['domicile', 'residence', 'habitation'],
      'rue': ['avenue', 'boulevard', 'voie'],
      'ville': ['cite', 'commune', 'agglomeration'],
      'travail': ['emploi', 'occupation', 'metier'],
      'argent': ['monnaie', 'especes', 'capital'],
      'temps': ['duree', 'periode', 'moment'],
      'grand': ['enorme', 'immense', 'gigantesque'],
      'petit': ['minuscule', 'minime', 'reduit'],
      'rapide': ['vite', 'accelere', 'prompt'],
      'lent': ['lentement', 'doucement'],
      'bon': ['excellent', 'parfait', 'formidable'],
      'mauvais': ['terrible', 'affreux', 'horrible'],
      'heureux': ['joyeux', 'content', 'ravi'],
      'triste': ['malheureux', 'chagrine', 'melancolique']
    };
