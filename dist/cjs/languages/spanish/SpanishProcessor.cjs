...
class SpanishProcessor extends LanguageProcessor.BaseLanguageProcessor {
  language = "spanish";
  displayName = "Español";
  supportedFeatures = [
    //
...
exports.SpanishProcessor = SpanishProcessor;
//# sourceMappingURL=SpanishProcessor.cjs.map
