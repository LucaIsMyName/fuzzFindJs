...
class FrenchProcessor extends LanguageProcessor.BaseLanguageProcessor {
  language = "french";
   ...
   */
  normalize(text) {
    return text.toLowerCase().trim().replace(/\s+/g, " ").replace(/[àáâãä]/g, "a").replace(/[èéêë]/g, "e").replace(/[ìíîï]/g, "i").replace(/[òóôõö]/g, "o").replace(/[ùúûü]/g, "u").replace(/ç/g, "c").replace(/ñ/g, "n").replace(/ÿ/g, "y");
  }
  /**
...
exports.FrenchProcessor = FrenchProcessor;
//# sourceMappingURL=FrenchProcessor.cjs.map
