...
class FQLExecutor {
  ...
  executeNot(node) {
    ...
    const allResults = index.getSuggestions(this.index, "", this.index.base.length, this.options);
   ...
   */
  executeTerm(term) {
    return index.getSuggestions(this.index, term, this.index.base.length, this.options);
  }
  /**
   * Execute phrase search
   */
  executePhrase(phrase) {
    return index.getSuggestions(this.index, `"${phrase}"`, this.index.base.length, this.options);
  }
  /**
  ...
  executeFilter(node) {
    ...
    const results = index.getSuggestions(this.index, value, this.index.base.length, this.options);
    switch (filterType) {
      case "exact":
...
exports.FQLExecutor = FQLExecutor;
exports.FQLTimeoutError = FQLTimeoutError;
